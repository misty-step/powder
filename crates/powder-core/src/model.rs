...
pub struct Run {
    ...
    /// Bounded scalar telemetry summary. Detailed attempts stay in the store child table.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// One provider/model attempt. Nullable fields preserve version skew and make
/// missing attribution explicit instead of fabricating a provider identity.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
...
impl Default for RunTelemetryAttemptInput {
    fn default() -> Self {
        Self {
            provider: None, model: None, harness: None, reasoning: None,
            input_tokens: None, output_tokens: None, reasoning_tokens: None,
            estimated_cost_usd_micros: None, duration_ms: None, outcome: None,
            pricing_version: None, input_rate_usd_per_million_micros: None,
            output_rate_usd_per_million_micros: None, reasoning_rate_usd_per_million_micros: None,
        }
    }
}
...
pub struct RunTelemetryWrite {
    ...
    #[serde(default)]
    pub summary: Option<RunTelemetrySummary>,
}
...
impl Default for RunTelemetryAggregateQuery {
    fn default() -> Self { Self { agent: None, model: None, provider: None, limit: 100 } }
}
